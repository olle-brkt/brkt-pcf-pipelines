...
ssh -i ssh-key -oStrictHostKeyChecking=no -oUserKnownHostsFile=/dev/null -oLogLevel=error ubuntu@$OPSMAN_DOMAIN_OR_IP_ADDRESS 'mkdir -p /tmp/stock_stemcells/; mv /var/tempest/stemcells/*.tgz /tmp/stock_stemcells/'
